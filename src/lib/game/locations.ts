...
export const LOCATIONS: ScoutLocation[] = [
  ...
  },
  {
    ...
    descricao: "Racha de fim de tarde na praça. Nenhum custo, nenhum controle — e de vez em quando um moleque diferente.",
    imagem: varzeaImg,
    categorias: ["Sub-11", "Sub-13", "Sub-15", "Sub-17", "Livre"],
    nivel: 1, custoViagem: 40, custoIngresso: 0,
    reputacaoMin: 0, prestigioMin: 1, publico: [5, 60],
  },
  {
    id: "campo-fabrica",
    nome: "Campo da Fábrica",
    descricao: "Torneio entre empresas. Muito veterano, mas há filhos e sobrinhos jogando junto com os pais.",
    imagem: campoImg,
    categorias: ["Sub-15", "Sub-17", "Sub-20", "Livre", "Veterano"],
    nivel: 2, custoViagem: 80, custoIngresso: 5,
    reputacaoMin: 0, prestigioMin: 1, publico: [40, 300],
  },
  {
    id: "bairro",
    nome: "Campeonato de Bairro",
    descricao: "Torneio de fim de semana entre vilas. Rivalidade pesada, arquibancada cheia e muita gente querendo aparecer.",
    imagem: campoImg,
    categorias: ["Sub-13", "Sub-15", "Sub-17", "Sub-20", "Livre", "Veterano"],
    nivel: 2, custoViagem: 65, custoIngresso: 8,
    reputacaoMin: 0, prestigioMin: 1, publico: [60, 500],
  },
  {
    id: "ferias",
    nome: "Torneio de Férias",
    descricao: "Competição relâmpago de janeiro e julho. Times de toda a região aproveitam o recesso escolar para jogar.",
    imagem: torneioImg,
    categorias: ["Sub-11", "Sub-13", "Sub-15", "Sub-17", "Sub-18"],
    nivel: 3, custoViagem: 120, custoIngresso: 15,
    reputacaoMin: 3, prestigioMin: 1, publico: [80, 900],
  },
  {
    id: "ginasio-futsal",
    nome: "Ginásio de Futsal",
    descricao: "Liga de futsal disputada no ginásio da cidade. Berço de craques: técnica em espaço curto e decisão rápida.",
    imagem: quadraImg,
    categorias: ["Sub-11", "Sub-13", "Sub-15", "Sub-17", "Sub-20", "Livre"],
    nivel: 4, custoViagem: 130, custoIngresso: 25,
    reputacaoMin: 6, prestigioMin: 1, publico: [200, 2500],
  },
  {
    id: "universitaria",
    nome: "Liga Universitária",
    descricao: "Atletas mais velhos que não vingaram na base, mas ainda podem render em divisões de acesso.",
    imagem: torneioImg,
    categorias: ["Sub-20", "Livre"],
    nivel: 4, custoViagem: 150, custoIngresso: 20,
    reputacaoMin: 8, prestigioMin: 1, publico: [100, 1200],
  },
  {
    id: "projeto-social",
    nome: "Projeto Social",
    descricao: "Núcleo de formação de bairro. Trabalha com crianças e adolescentes e conhece cada família da região.",
    imagem: escolinhaImg,
    categorias: ["Sub-11", "Sub-13", "Sub-15", "Sub-17"],
    nivel: 3, custoViagem: 90, custoIngresso: 0,
    reputacaoMin: 2, prestigioMin: 1, publico: [20, 150],
  },
  {
    id: "escola",
  ...
  {
    id: "peneira-aberta",
    nome: "Peneira Aberta de Clube",
    descricao: "Centenas de garotos em um único campo, 15 minutos cada. Caos absoluto — e ocasionalmente um achado.",
    imagem: campoImg,
    categorias: ["Sub-13", "Sub-15", "Sub-17", "Sub-18", "Sub-20"],
    nivel: 4, custoViagem: 160, custoIngresso: 0,
    reputacaoMin: 12, prestigioMin: 1, publico: [100, 900],
  },
  {
    id: "interior",
    nome: "Liga do Interior",
    descricao: "Campeonato de cidades pequenas, com atletas semiprofissionais e muito jogo direto.",
    imagem: torneioImg,
    categorias: ["Sub-15", "Sub-17", "Sub-20", "Livre"],
    nivel: 4, custoViagem: 190, custoIngresso: 25,
    reputacaoMin: 16, prestigioMin: 1, publico: [150, 1200],
  },
  {
    id: "regional",
  ...
  {
    id: "ct-d",
    nome: "CT de clube da Série D",
    descricao: "Estrutura simples, campo de treino e um técnico que conhece todo mundo no futebol da região.",
    imagem: ctImg,
    categorias: ["Sub-15", "Sub-17", "Sub-20", "Livre"],
    nivel: 5, custoViagem: 240, custoIngresso: 0,
    reputacaoMin: 26, prestigioMin: 2, publico: [0, 40],
  },
  {
    id: "copa-base-nacional",
    nome: "Copa Nacional de Base",
    descricao: "Times de todo o país reunidos em uma semana de jogos. Ótimo custo-benefício para mapear talentos.",
    imagem: copaImg,
    categorias: ["Sub-13", "Sub-15", "Sub-17"],
    nivel: 6, custoViagem: 520, custoIngresso: 40,
    reputacaoMin: 36, prestigioMin: 2, publico: [400, 3500],
  },
  {
    id: "estadual",
  ...
  {
    id: "selecao-sub15",
    nome: "Seleção Estadual Sub-15",
    descricao: "Peneira final da federação. Os melhores garotos do estado em uma semana de treinos fechados.",
    imagem: torneioImg,
    categorias: ["Sub-15"],
    nivel: 8, custoViagem: 1100, custoIngresso: 0,
    reputacaoMin: 70, prestigioMin: 4, publico: [0, 300],
  },
  {
    id: "copa-juniores",
  ...
  },
  {
    id: "mundial-sub20",
    nome: "Mundial Sub-20",
    descricao: "O palco máximo da formação. Só quem tem nome no futebol mundial consegue credencial.",
    imagem: eliteImg,
    categorias: ["Sub-20"],
    nivel: 10, custoViagem: 7500, custoIngresso: 300,
    reputacaoMin: 96, prestigioMin: 5, publico: [8000, 45000],
  },
];
